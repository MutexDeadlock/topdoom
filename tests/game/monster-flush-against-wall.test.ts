...
function travelled(world: World, body: MonsterBody, target: Pos3, seconds: number): number {
  return chaseFor(body, stats, world, target, seconds);
}

describe('Monster AI · a monster spawned flush against a wall', () => {
